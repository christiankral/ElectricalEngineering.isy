...
for file in $(find . -maxdepth 1 -name "$1"); do
  ...
  sed -i 's!"Basic/Diode(s)"!"Basic/Diode(sf)"!g' "${file}"
  sed -i 's!"Basic/Diode"!"Basic/Diode(sf)"!g' "${file}"
  sed -i 's!"Basic/Inductor"!"Basic/Inductor(s)"!g' "${file}"
  sed -i 's!"Basic/Inductor coil"!"Basic/Inductor coil(s)"!g' "${file}"
  sed -i 's!"Basic/Lamp(s)"!"Basic/Lamp(sf)"!g' "${file}"
  sed -i 's!"Basic/Lamp"!"Basic/Lamp(sf)"!g' "${file}"
  sed -i 's!"Basic/Fuse(s)"!"Basic/Fuse(sf)"!g' "${file}"
  sed -i 's!"Basic/Fuse"!"Basic/Fuse(sf)"!g' "${file}"
  ...
  sed -i 's!"Basic/Resistor(s)"!"Basic/Resistor(sf)"!g' "${file}"
  sed -i 's!"Basic/Resistor"!"Basic/Resistor(sf)"!g' "${file}"
